...
public class CardAnimator {
    ...
    private boolean mAnimateBackCards;
    ...
    public CardAnimator(ArrayList<View> viewCollection, int backgroundColor, int stackMargin, boolean animateBackCards) {
        mCardCollection = viewCollection;
        mBackgroundColor = backgroundColor;
        mStackMargin = stackMargin;
        mAnimateBackCards = animateBackCards;
        setup();
    }
